...
public class EnrolleeController {
    ...
    public  ResponseEntity<String> createEnrollee(@RequestBody EnrolleeDTO dto) {
    	try{
    		String errorMessage=validateEnrolleeDTO(dto);
    ...
    private String validateEnrolleeDTO(EnrolleeDTO dto) {
		String message="";
    	if(dto.getId()!=null) {
    		message="Enrollee Id is required";
    	}else if(dto.getName()!=null) {
    		message="Enrollee Name is required";
    	}else if(dto.getDateOfBirth()!=null) {
    		message="Enrollee DateOfBirth is required";
    	}
		return message;
	}
